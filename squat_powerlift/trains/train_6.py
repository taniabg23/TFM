...
from tensorflow.keras.layers import LSTM, Dense, Dropout, Masking, BatchNormalization, Layer
...
def save_history_csv(history, filepath="./csvs/training_history_6.csv"):
...
def save_learning_curves(history, filepath="./csvs/learning_curves_6.png"):
    try:
        import matplotlib.pyplot as plt
    except Exception:
        print("No se pudo generar learning_curves_6.png (matplotlib no disponible).")
        return
...
callbacks = [
    ...
    ModelCheckpoint(
        "./models/bests/best_squat_model_6.keras",
        monitor="val_loss",
        save_best_only=True,
        verbose=1
    )
...
save_history_csv(history, filepath="./csvs/training_history_6.csv")
save_learning_curves(history, filepath="./csvs/learning_curves_6.png")
...
model.save("./models/squat_model_final_6.h5")
model.save("./models/squat_model_final_6.keras")